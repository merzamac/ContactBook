    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card-body">
                ...
                <div id="contenedor-flex" class="flex-form"></div>
                <button type="submit" class="btn-submit">
                Validar y Sobrescribir Archivo JSON
                </button>
                </form> --}}
            ...
            {{-- Pasamos la configuración a JS o simplemente llamamos al script --}}
            </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    campos: [
        ...
        { id: "genero", label: "Género", tipo: "select", opciones: ["femenino", "masculino", "otros"] },
        { id: "telefono", label: "Teléfono (Formato: 0000-0000000)", tipo: "text" },
        { id: "correo", label: "Correo Electrónico", tipo: "email" },
        { id: "estado_civil", label: "Estado Civil", tipo: "select", opciones: ["soltero", "casado", "divorciado", "concubinato", "viudo"] },
